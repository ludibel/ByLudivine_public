...
// import interne
import PortfolioMenu from '@components/Nav/PortfolioMenu';
// style avec Emotion
...
const NavBar = ({ logo }) => {
  ...
  const getMenuButtons = () => {
    // si la route n'est pas sur la page d'accueil la nav affiche: Accueil et Portfolio
    if (router.asPath !== '/') {
    ...
    // si la route est sur Accueil alors la nav affiche: Accueil/PortFolio/Technos/Contact
    if (router.asPath === '/') {
